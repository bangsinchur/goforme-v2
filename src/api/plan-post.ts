...
function buildQueryString({isAssigned=false,tripType,keyword,orderBy,page,pageSize,id}:RequestParams) {
...
export async function fetchSendEstimate({planId,quoteData}:EstimateVariables){
    try{
